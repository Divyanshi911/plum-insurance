...
# ── REMOVED ───────────────────────────────────────────────────────────────────
# from backend.agents.orchestrator_agent import orchestrator   ← delete this
# from google.adk.runners import Runner                        ← delete this
# from google.adk.sessions import InMemorySessionService       ← delete this
# from google.genai import types                               ← delete this
# _session_service = InMemorySessionService()                  ← delete this
# _runner = Runner(...)                                        ← delete this
# ─────────────────────────────────────────────────────────────────────────────
...
async def submit_claim(
    ...
    state = preprocess_upload_files(state)
    state = document_tool_fn(state)
    state = extraction_tool_fn(state)
